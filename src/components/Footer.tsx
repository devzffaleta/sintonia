    ...
    <footer className="bg-black text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Teatro Infinito</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">contato@teatroinfinito.com.br</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-6 mt-6 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
          <p>© {new Date().getFullYear()} Teatro Infinito. Todos os direitos reservados.</p>
